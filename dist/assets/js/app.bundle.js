...
exports.default = function () {
  ...
  var injectImageSrc = function injectImageSrc() {
    $image.each(function (i, el) {
      var $t = $(el);
      var $src = $t.attr('data-lazy');
      $t.attr('src', $src);
      $t.on('load', function () {
        return $t.parents('figure').addClass('is-loaded');
      });
    });
  };
...
exports.default = function () {
  ...
  var killdropdown = function killdropdown() {
    downDownShowing = false;
    if ($mTrigger.is(":visible")) {
...
exports.default = function () {
  ...
  var scrollHomeHero = function scrollHomeHero() {
    if ($bgEl) {
      $bgEl.css({
...
exports.default = function () {
  var jQueryBridget = __webpack_require__(11);
  var Flickity = __webpack_require__(12);
  var $threeBlockParent = $('.three-card-block');
  var $mobileEl = $('.mt-trigger');
  var $btn = $('.next');
  var $slideTest = $('.slide-parent-card');
  var $slideBtnTest = $('.slide-item-btn');
  ...
  var swapTest = function swapTest(event) {
    var $t = $(event.currentTarget);
    var $getBase = $t.parents('.two-col-slide-main').find('.slide-parent-card');
...
exports.default = function () {
  var $navLinks = $('a[href*="localhost"], a[href*="ispykenny.com"], a[href*="hyperfitmd.com"], a[href*="hyperfit"]');
